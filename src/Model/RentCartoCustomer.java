...
public class RentCartoCustomer {
    ...
    public RentCartoCustomer(String registerationNum, String CustomerID, String CustomerName, StatusoftheCar status) {
    ...
    public void cardetails(){
        RentCartoCustomer car1 = new RentCartoCustomer("ABC123", "Blue", new Date(), new Date(), 100.0f, StatusoftheCar.InShop, BodyTypeofCar.SEDAN);
RentCartoCustomer car2 = new RentCartoCustomer("XYZ456", "Red", new Date(), new Date(), 120.0f, StatusoftheCar.InShop, BodyTypeofCar.SUV);
RentCartoCustomer car3 = new RentCartoCustomer("DEF789", "Green", new Date(), new Date(), 90.0f, StatusoftheCar.InShop, BodyTypeofCar.HATCHBACK);
RentCartoCustomer car4 = new RentCartoCustomer("GHI012", "Black", new Date(), new Date(), 110.0f, StatusoftheCar.InShop, BodyTypeofCar.VAN);
RentCartoCustomer car5 = new RentCartoCustomer("JKL345", "Silver", new Date(), new Date(), 95.0f, StatusoftheCar.InShop, BodyTypeofCar.SEDAN);
RentCartoCustomer car6 = new RentCartoCustomer("MNO678", "White", new Date(), new Date(), 130.0f, StatusoftheCar.InShop, BodyTypeofCar.SUV);
RentCartoCustomer car7 = new RentCartoCustomer("PQR901", "Yellow", new Date(), new Date(), 105.0f, StatusoftheCar.InShop, BodyTypeofCar.HATCHBACK);
RentCartoCustomer car8 = new RentCartoCustomer("STU234", "Gray", new Date(), new Date(), 115.0f, StatusoftheCar.InShop, BodyTypeofCar.VAN);
RentCartoCustomer car9 = new RentCartoCustomer("VWX567", "Brown", new Date(), new Date(), 98.0f, StatusoftheCar.InShop, BodyTypeofCar.SEDAN);
RentCartoCustomer car10 = new RentCartoCustomer("YZA890", "Purple", new Date(), new Date(), 125.0f, StatusoftheCar.InShop, BodyTypeofCar.SUV);
